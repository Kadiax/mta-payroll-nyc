...
> Same diagram as the root [README](../../README.md) — kept duplicated on purpose (GitHub Markdown has no include/transclusion mechanism to reference one source from two files) so this diagrams-focused doc still shows it directly instead of just linking out.
